...
import 'package:ebazar/ui/user_form.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          // ( FirebaseAuth.instance.createUserWithEmailAndPassword(email:_emailController.text, password: _passwordController.text).onError((error, stackTrace) => print(object)));
                                // Navigator.push(
                                //     context,
                                //     CupertinoPageRoute(
