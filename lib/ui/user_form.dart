...
import 'package:ebazar/ui/bottom_nav_controller.dart';
import 'package:ebazar/ui/login_screen.dart';
import 'package:ebazar/widgets/customButton.dart';
import 'package:ebazar/widgets/myTextField.dart';
...
class _UserFormState extends State<UserForm> {
  ...
  sendUserDataToDB()async{
    ...
    }).then((value) => Navigator.push(context, MaterialPageRoute(builder: (_)=>LoginScreen()))).catchError((error)=>print("something is wrong. $error"));
  }
